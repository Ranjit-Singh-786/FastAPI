...
class Settings(BaseSettings):
    ...
    # User service address for verification calls
    ...
    MYSQL_FARMS_DB: str = "smartfarm_farms"
    ...
    def db_url(self) -> str:
        ...
        return f"mysql+pymysql://{self.MYSQL_USER}:{quote_plus(self.MYSQL_PASSWORD)}@{self.MYSQL_HOST}:{self.MYSQL_PORT}/{self.MYSQL_FARMS_DB}"
